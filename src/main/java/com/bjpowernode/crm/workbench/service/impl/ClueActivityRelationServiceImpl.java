...
public class ClueActivityRelationServiceImpl implements ClueActivityRelationService {
    ...
    @Override
    public int saveBuildConnectionBetweenClueAndActivity(List<ClueActivityRelation> relationList) {
        return clueActivityRelationMapper.insertClueAndActivity(relationList);
    }
